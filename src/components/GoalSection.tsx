    ...
    <section className="py-16 px-6 bg-gray-50">
      <div className="max-w-7xl mx-auto text-center arabic-text">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {features.map((feature, index) => (
            <div key={index} className="text-center">
              ...
              <h3 className="font-bold text-gray-800 mb-4 min-h-[60px]">{feature.title}</h3>
        ...
        <div className="relative flex justify-center">
          <div className="w-64 h-64 bg-khedamni-blue rounded-full flex items-center justify-center relative">
            {/* Globe continents */}
            <div className="w-48 h-48 relative">
              <div className="absolute top-8 left-8 w-16 h-12 bg-green-400 rounded-lg opacity-80"></div>
              <div className="absolute top-12 right-12 w-12 h-16 bg-green-500 rounded-lg opacity-70"></div>
              <div className="absolute bottom-8 left-12 w-20 h-10 bg-green-400 rounded-lg opacity-60"></div>
            </div>
            
            {/* Floating icons around globe */}
            <div className="absolute -top-4 -right-4 w-12 h-12 bg-khedamni-orange rounded-full flex items-center justify-center text-white">
              🔧
            </div>
            <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-yellow-400 rounded-full flex items-center justify-center">
              ⚡
            </div>
            <div className="absolute top-1/4 -left-8 w-12 h-12 bg-orange-400 rounded-full flex items-center justify-center">
              🏠
            </div>
            <div className="absolute bottom-1/4 -right-8 w-12 h-12 bg-yellow-500 rounded-full flex items-center justify-center">
              💼
            </div>
          </div>
        </div>
